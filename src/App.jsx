...
export default function App() {
  ...
  // Consulta dinámica a Sanity con fallback seguro
  useEffect(() => {
    ...
    fetch(url)
      ...
      .catch(err => {
        console.log("Consulta de Sanity con fallback local:", err);
        setCargandoNoticias(false);
      });
  }, []);

  // Catálogo de Productos (León Store + Fight Shop)
  const products = [
    {
      id: 'original-01',
      ...
      description: 'Corte oversize urbano. Algodón de alta durabilidad pensado para soportar el entrenamiento diario y marcar presencia.',
      sizes: ['S', 'M', 'L', 'XL', 'XXL']
    },
    {
      id: 'bolivia-remera',
      ...
      description: 'Edición oficial de campaña. El margen neto cubre gastos logísticos y pasajes del campamento en altura.',
      sizes: ['S', 'M', 'L', 'XL', 'XXL']
    },
    {
      id: 'bolivia-hoodie',
      ...
      badge: '100% A BENEFICIO',
      badgeColor: 'bg-emerald-950 text-emerald-400 border-emerald-500/40',
      description: 'Buzo pesados con capucha doble, puños reforzados y estampado táctico de alto impacto en la espalda.',
      sizes: ['S', 'M', 'L', 'XL', 'XXL']
    },
    {
      id: 'fight-vendas',
      ...
      description: 'Vendas semi-elásticas con velcro reforzado y sujeción de pulgar para máximo soporte en sparring y bolsa.',
      sizes: ['ÚNICO']
    },
    {
      id: 'fight-soga',
      name: 'SOGA DE VELOCIDAD ALTA DENSIDAD',
      ...
      badge: 'PROXIMAMENTE',
      badgeColor: 'bg-yellow-950 text-yellow-400 border-yellow-500/30',
      description: 'Soga técnica con rulemanes de alta velocidad para acondicionamiento físico y ritmo de pelea.',
      sizes: ['AJUSTABLE']
    }
  ];

  // Datos de El Camino (Docuseries / Bitácora)
  const episodiosDocu = [
    {
      id: 'ep-01',
      season: 'temp1',
      ...
      duration: '08:45 min',
      thumbnail: '/E-576.jpg',
      description: 'El anuncio oficial del objetivo internacional. La decisión de ir por el campamento en altura en Santa Cruz de la Sierra.',
    ...
    },
    {
      ...
      season: 'temp1',
      number: 'EP. 02',
      title: 'Doble Turno en IMAD',
      date: 'Febrero 2026',
      duration: '12:10 min',
      thumbnail: '/20240203092340_IMG_2552.jpg',
      description: 'Rutina completa de bolsa pesada, preparación física y planificación del campamento con el equipo.',
      videoUrl: 'https://instagram.com/joelbox_'
    },
    {
      id: 'ep-03',
      ...
      description: 'Cómo autogestionamos la indumentaria oficial para financiar los costos logísticos y los pasajes.',
      videoUrl: 'https://instagram.com/joelbox_'
    }
  ];
  ...
  const createOrderWhatsapp = (product) => {
    ...
    const msg = `¡Hola Joel! Quiero reservar la prenda/producto: *${product.name}* en Talle/Formato *${size}*.\n\n` +
      `• Precio Preventa: ${formatCurrency(product.price)}\n` +
      `• Seña a transferir (50%): ${formatCurrency(product.deposit)}\n\n` +
  ...
  const createSponsorWhatsapp = () => {
    const msg = `¡Hola Joel! Me interesa sumarme como ALIADO / SPONSOR para apoyar tu carrera y la Operación Santa Cruz Bolivia 2026. Quisiera coordinar una propuesta.`;
    window.open(`https://wa.me/${whatsappNumber}?text=${encodeURIComponent(msg)}`, '_blank');
  };
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 font-sans selection:bg-yellow-500 selection:text-black pb-12">
      ...
      <header className="sticky top-0 z-50 bg-black/95 backdrop-blur-md border-b border-zinc-800/80 px-4 pt-3.5 pb-2">
        ...
        {/* NAVEGACIÓN EN PESTAÑAS (HUB DE UNIVERSO) */}
      ...
      <main className="max-w-6xl mx-auto px-4 pt-6">
          ...
          <div className="space-y-10">
            ...
            <section className="relative rounded-3xl overflow-hidden border border-zinc-800 p-6 sm:p-12 text-center bg-zinc-950">
              <div className="absolute inset-0 z-0">
                <img src="/E-576.jpg" alt="Joel Diaz El León" className="w-full h-full object-cover object-center opacity-35 filter grayscale" />
              ...
              <div className="relative z-10 space-y-4 max-w-2xl mx-auto">
                <span className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-emerald-950 text-emerald-400 text-xs font-bold border border-emerald-500/30">
                  <Zap className="w-3.5 h-3.5" /> CAPÍTULO ACTIVO: OPERACIÓN SANTA CRUZ 2026
                </span>
                ...
                <p className="text-zinc-300 text-xs sm:text-sm leading-relaxed max-w-lg mx-auto">
                  Sitio oficial de <strong>Joel Diaz (@joelbox_)</strong>. Boxeo amateur, bitácora audiovisual, indumentaria y financiamiento transparente.
                </p>
            ...
            <section className="bg-zinc-950 border border-zinc-800 p-6 sm:p-8 rounded-2xl space-y-5">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                <div>
                  ...
                  <p className="text-xs text-zinc-400 mt-0.5">Financiamiento de campamento en altura, pasajes y logística internacional.</p>
                </div>

                <div className="sm:text-right">
                  <span className="text-[10px] text-zinc-400 uppercase font-mono block">Recaudación Misión</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t border-zinc-900">
                <div className="bg-zinc-900/60 p-3.5 rounded-xl border border-zinc-800/80">
                  <span className="text-xs font-bold text-yellow-400 block uppercase">1. Producción</span>
                  <p className="text-[11px] text-zinc-400 mt-0.5">Parte de tu compra cubre el costo directo del proveedor textil.</p>
                </div>
                <div className="bg-zinc-900/60 p-3.5 rounded-xl border border-zinc-800/80">
                  <span className="text-xs font-bold text-yellow-400 block uppercase">2. Logística & Viajes</span>
                  <p className="text-[11px] text-zinc-400 mt-0.5">El margen neto se destina exclusivamente a boletos, traslados y estadía.</p>
                </div>
                <div className="bg-zinc-900/60 p-3.5 rounded-xl border border-zinc-800/80">
                  <span className="text-xs font-bold text-yellow-400 block uppercase">3. Preparación</span>
                  <p className="text-[11px] text-zinc-400 mt-0.5">Soporta la indumentaria de combate, nutrición y equipo de entrenamiento.</p>
                </div>
              </div>
            </section>

            {/* PRÓXIMO COMBATE DESTACADO */}
            ...
            {/* SECCIÓN "NO ME CREAS. MIRÁ." (EVIDENCIA & TRABAJO REAL) */}
            <section className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <span className="text-xs font-bold tracking-widest text-yellow-400 uppercase block">Evidencia Social</span>
                  <h2 className="text-2xl font-black text-white uppercase">NO ME CREAS. MIRÁ.</h2>
                </div>
                <span className="text-xs text-zinc-500 hidden sm:inline">Trabajo real día a día</span>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-zinc-800 group">
                  <img src="/20240203092340_IMG_2552.jpg" alt="Entrenamiento en bolsa" className="w-full h-full object-cover group-hover:scale-105 transition-all duration-300" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-90" />
                  <div className="absolute bottom-3 left-3 right-3">
                    <span className="text-[10px] text-yellow-400 font-bold uppercase block">Gimnasio IMAD</span>
                    <span className="text-xs font-bold text-white uppercase block">Sesión de Bolsa Pesada</span>
                  </div>
                </div>
                ...
                <div className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-zinc-800 group">
                  ...
                  <div className="absolute bottom-3 left-3 right-3">
                    ...
                    <span className="text-xs font-bold text-white uppercase block">Preparación táctica</span>
                  </div>
                </div>

                <div className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-zinc-800 group">
                  <img src="/E-543.jpg" alt="En guardia" className="w-full h-full object-cover group-hover:scale-105 transition-all duration-300" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-90" />
                  <div className="absolute bottom-3 left-3 right-3">
                    <span className="text-[10px] text-yellow-400 font-bold uppercase block">Foco & Disciplina</span>
                    <span className="text-xs font-bold text-white uppercase block">Rumbo al Profesionalismo</span>
                  </div>
                </div>
              </div>
            </section>
        ...
        {/* 2. VISTA: LEÓN STORE & FIGHT SHOP */}
        {activeTab === 'tienda' && (
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
              <div>
                <span className="text-xs font-bold tracking-widest text-yellow-400 uppercase">Tienda del Universo</span>
                <h2 className="text-3xl font-black text-white uppercase">LEÓN STORE</h2>
                <p className="text-xs text-zinc-400 mt-1">Reserva el 50% por WhatsApp y salda al recibir la prenda.</p>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-bold uppercase transition-all ${
                    selectedCategory === 'todos' ? 'bg-yellow-400 text-black' : 'bg-zinc-900 text-zinc-400 border border-zinc-800'
                  }`}
                >
                  Todos
                </button>
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-bold uppercase transition-all ${
                    selectedCategory === 'merch' ? 'bg-yellow-400 text-black' : 'bg-zinc-900 text-zinc-400 border border-zinc-800'
                  }`}
                >
                  Línea Original
                </button>
                <button
                  onClick={() => setSelectedCategory('santa_cruz')}
                  className={`px-3 py-1.5 rounded-lg text-xs font-bold uppercase transition-all ${
                    selectedCategory === 'santa_cruz' ? 'bg-yellow-400 text-black' : 'bg-zinc-900 text-zinc-400 border border-zinc-800'
                  }`}
                >
                  Campaña Bolivia 2026
                </button>
                <button
                  onClick={() => setSelectedCategory('fight_shop')}
                  className={`px-3 py-1.5 rounded-lg text-xs font-bold uppercase transition-all ${
                    selectedCategory === 'fight_shop' ? 'bg-yellow-400 text-black' : 'bg-zinc-900 text-zinc-400 border border-zinc-800'
                  }`}
                >
                  Fight Shop
                </button>
                ...
                <div key={p.id} className="bg-zinc-950 rounded-2xl border border-zinc-800 overflow-hidden flex flex-col justify-between hover:border-zinc-700 transition-all">
                  <div>
                    ...
                    <div className="p-5 space-y-3">
                      ...
                      <div className="pt-2">
                        <label className="text-[11px] font-bold text-zinc-400 uppercase block mb-1.5">Talle / Formato:</label>
                      ...
                      <div className="pt-3 border-t border-zinc-900 flex justify-between items-end">
                        ...
                        <div className="text-right">
                          <span className="text-[10px] text-yellow-400 block uppercase font-bold">Seña Reserva (50%)</span>
        ...
        {/* 3. VISTA: EL CAMINO (DOCUSERIES / BITÁCORA AUDIOVISUAL) */}
        {activeTab === 'elcamino' && (
          <div className="space-y-8">
            <div className="text-center space-y-2">
              ...
              <p className="text-xs sm:text-sm text-zinc-400 max-w-xl mx-auto">
                El detrás de escena del gimnasio, los viajes y la preparación diaria hacia las metas.
              </p>
            </div>
              ...
              {episodiosDocu.map((ep) => (
                <div key={ep.id} className="bg-zinc-950 border border-zinc-800 rounded-2xl overflow-hidden flex flex-col justify-between">
                  ...
                  <div className="p-5 pt-0">
                    ...
                    >
                      <Video className="w-4 h-4 text-yellow-400" /> Ver en Redes
                    </a>
                  </div>
                </div>
              ))}
        ...
        {/* 4. VISTA: NOTICIAS (MEDIO OFICIAL + SANITY) */}
        {activeTab === 'noticias' && (
                ...
                <div className="space-y-4">
                  <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-6 space-y-3">
                    ...
                    <p className="text-xs text-zinc-300 leading-relaxed">
                      Iniciamos la preventa del catálogo oficial de indumentaria para cubrir el margen de pasajes y logística del campamento en altura en Santa Cruz.
                    </p>
                  </div>
                  ...
                  <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-6 space-y-3">
                    ...
                    <h3 className="text-xl font-black text-white uppercase">Doble turno y guanteo intensivo en IMAD</h3>
                    <p className="text-xs text-zinc-300 leading-relaxed">
                      Intensificamos el acondicionamiento físico y los sparrings de alta exigencia de cara a los próximos compromisos provinciales y regionales.
                    </p>
                  </div>
                </div>
              )}
        ...
        {/* 5. VISTA: EL RING / HISTORIAL DEPORTIVO */}
        {activeTab === 'elring' && (
          <div className="space-y-8 max-w-4xl mx-auto">
            <div className="text-center space-y-2">
              <span className="text-xs font-bold tracking-widest text-yellow-400 uppercase">Historial de Combates</span>
              <h2 className="text-3xl font-black text-white uppercase tracking-tight">EL RING</h2>
              <p className="text-xs sm:text-sm text-zinc-400 max-w-md mx-auto">
                Registro oficial de combates amateur y camino hacia el profesionalismo.
              </p>
            </div>

            {/* Ficha Técnica */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 bg-zinc-950 border border-zinc-800 p-6 rounded-2xl text-center">
              <div>
              ...
              <div>
                <span className="block text-2xl font-black text-white">Joel Diaz</span>
                <span className="text-[10px] text-zinc-400 uppercase font-bold">Nombre Oficial</span>
              </div>
            </div>

            {/* Lista de Peleas */}
            <div className="space-y-3">
              <span className="text-xs font-bold text-zinc-400 uppercase block">Bitácora de Combates</span>
        ...
        {activeTab === 'lamanada' && (
          <div className="space-y-8 max-w-3xl mx-auto">
            <div className="text-center space-y-2">
              ...
              <p className="text-xs sm:text-sm text-zinc-400 max-w-md mx-auto">
                No solo comprás una prenda o mirás un video: formás parte directa de la preparación.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-zinc-950 via-zinc-900 to-zinc-950 border border-yellow-500/30 rounded-2xl p-8 text-center space-y-5">
              ...
              <h3 className="text-2xl sm:text-3xl font-black text-white uppercase">Acceso al Día a Día del Equipo</h3>
        ...
        {activeTab === 'aliados' && (
          <div className="space-y-8 max-w-3xl mx-auto">
            ...
            <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-8 text-center space-y-5">
              <h3 className="text-2xl font-black text-white uppercase">Formas de Colaboración</h3>
        ...
        {/* 8. VISTA: EL LEÓN SE FINANCIA (HUB DE TRANSPARENCIA) */}
        {activeTab === 'financiacion' && (
          <div className="space-y-8 max-w-4xl mx-auto">
            <div className="text-center space-y-2">
              <span className="text-xs font-bold tracking-widest text-yellow-400 uppercase">Sistema Transparente</span>
              <h2 className="text-3xl font-black text-white uppercase tracking-tight">EL LEÓN SE FINANCIA</h2>
              <p className="text-xs sm:text-sm text-zinc-400 max-w-md mx-auto">
                Cómo se sostiene el proyecto deportivo de manera autogestionada.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-zinc-950 border border-zinc-800 p-6 rounded-2xl space-y-3">
                ...
                <p className="text-xs text-zinc-400 leading-relaxed">
                  Venta de indumentaria propia. Cada prenda vendida genera el margen neto que financia los viajes.
                </p>
              </div>
              ...
              <div className="bg-zinc-950 border border-zinc-800 p-6 rounded-2xl space-y-3">
                ...
                <p className="text-xs text-zinc-400 leading-relaxed">
                  Marcas y comercios que aportan recursos, canjes y suplementación para la preparación.
                </p>
              </div>

              <div className="bg-zinc-950 border border-zinc-800 p-6 rounded-2xl space-y-3">
                <Dumbbell className="w-6 h-6 text-yellow-400" />
                <h3 className="text-lg font-black text-white uppercase">3. Clases & Personalizados</h3>
                <p className="text-xs text-zinc-400 leading-relaxed">
                  Entrenamiento técnico y acondicionamiento físico impartido por Joel Diaz.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* 9. VISTA: EL ARCHIVO (CRONOLOGÍA HISTÓRICA) */}
        {activeTab === 'archivo' && (
          <div className="space-y-8 max-w-3xl mx-auto">
            <div className="text-center space-y-2">
              <span className="text-xs font-bold tracking-widest text-yellow-400 uppercase">Línea del Tiempo</span>
              <h2 className="text-3xl font-black text-white uppercase tracking-tight">EL ARCHIVO HISTÓRICO</h2>
              <p className="text-xs sm:text-sm text-zinc-400 max-w-md mx-auto">
                La memoria permanente de la carrera de Joel Diaz.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="border-l-2 border-yellow-400 pl-6 space-y-2">
                ...
                <p className="text-xs text-zinc-400">Inicio de la preventa internacional y preparación del campamento en altura en Bolivia.</p>
              </div>
              ...
              <div className="border-l-2 border-zinc-800 pl-6 space-y-2">
                ...
                <h3 className="text-xl font-black text-white uppercase">Consolidación Amateur en IMAD</h3>
                <p className="text-xs text-zinc-400">Temporada de peleas provinciales y fortalecimiento del equipo de entrenamiento en Rosario/Santo Tomé.</p>
              </div>

              <div className="border-l-2 border-zinc-800 pl-6 space-y-2">
                <span className="text-xs font-bold text-zinc-500 font-mono">2024</span>
                <h3 className="text-xl font-black text-white uppercase">Formación e Inicio de la Marca</h3>
                <p className="text-xs text-zinc-400">Primeras sesiones documentadas y nacimiento del concepto "El León".</p>
              </div>
            </div>
          </div>
        )}
